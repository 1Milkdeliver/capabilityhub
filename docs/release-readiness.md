...
|---|---|---|
| Manifest and registry | JSON `v1alpha1` parsing, deterministic export, explicit v1alpha0 alias migration, feature handshake, immutable revisions, activation pointers, dependency/conflict checks | Local compatibility surface only; no stable deprecation window or YAML parser |
