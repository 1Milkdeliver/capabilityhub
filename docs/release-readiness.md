...
| CLI and MCP | Four local commands and three MCP tools tested with the official SDK's in-memory client | Experimental local interface; zero-config MCP catalog is intentionally empty |
